...
public class UI_ElegirTienda6 : UI_Window
{
    [Header("Boton Cerrar")]
    ...
    [SerializeField] private long baseCost = 100000;
    ...
    private void RefrescarUI()
    {
        ...
        if (SaveService.Tienda6Bought) //modificamos
        {
    ...
    private void Comprar()
    {
        ...
        GameManager.Instance.MarcarItem6Comprado();
