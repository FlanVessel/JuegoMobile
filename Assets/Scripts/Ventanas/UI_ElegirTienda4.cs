...
public class UI_ElegirTienda4 : UI_Window
{
    [Header("Boton Cerrar")]
    ...
    [SerializeField] private long baseCost = 3000;
    ...
    private void RefrescarUI()
    {
        ...
        if (SaveService.Tienda4Bought) //modificamos
        {
    ...
    private void Comprar()
    {
        ...
        GameManager.Instance.MarcarItem4Comprado();
