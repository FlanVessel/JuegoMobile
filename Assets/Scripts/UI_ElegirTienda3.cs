...
public class UI_ElegirTienda3 : UI_Window
{
    [Header("Boton Cerrar")]
    ...
    [SerializeField] private long baseCost = 1500;
    ...
    private void RefrescarUI()
    {
        ...
        if (SaveService.Tienda3Bought) //modificamos
        {
    ...
    private void Comprar()
    {
        ...
        GameManager.Instance.MarcarItem3Comprado();
